...
<body>
    ...
    <div class="form-container">
        <form action="Seleccionar_equipo_editar.php" method="post">
    <input type="hidden" name="comuna_id" value="<?php echo htmlspecialchars($selectedComunaId); ?>">
    <input type="hidden" name="liga_id" value="<?php echo htmlspecialchars($selectedLigaId); ?>">
    <label for="temporada">Elige una temporada:</label>
    <select name="temporada_id" id="temporada" required>
